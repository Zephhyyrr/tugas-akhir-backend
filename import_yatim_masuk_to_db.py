...
# 2. Path ke file Excel Kas Anak Yatim - Uang Masuk
#    Ganti nama file berikut sesuai nama file Excel Anda yang sudah ditempatkan di folder Backend
EXCEL_FILE_PATH = r"D:\Laporan Kuliah Semester 8\CODE\Backend\Rekapitulasi_Yatim_Masuk_Clean.xlsx"
...
def import_data():
    ...
    try:
        ...
        conn.commit()
        print(f"✅ Berhasil! {len(data_to_insert)} data Uang Masuk Kas Anak Yatim dimasukkan ke database.")
    except Exception as e:
        conn.rollback()
...
if __name__ == "__main__":
    print("=" * 55)
    print("  IMPORT UANG MASUK - KAS ANAK YATIM (jenisKasId=2)")
    print("=" * 55)
    import_data()
